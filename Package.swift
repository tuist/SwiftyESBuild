...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/apple/swift-log.git", .upToNextMinor(from: "1.5.4")),
        .package(url: "https://github.com/swift-server/async-http-client.git", .upToNextMinor(from: "1.20.1")),
    ],
    targets: [
